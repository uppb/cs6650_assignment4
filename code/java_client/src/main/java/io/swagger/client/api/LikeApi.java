...
public class LikeApi {
     ...
     */
    public com.squareup.okhttp.Call getLikesCall(String albumID, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        Object localVarPostBody = null;
        
        // create path and map variables
        String localVarPath = "/review/{albumID}"
        ...
        final String[] localVarAccepts = {
            "applications/json", "application/json"
        };
    ...
    private com.squareup.okhttp.Call getLikesValidateBeforeCall(String albumID, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        // verify the required parameter 'albumID' is set
        if (albumID == null) {
            throw new ApiException("Missing the required parameter 'albumID' when calling getLikes(Async)");
        }
        
        com.squareup.okhttp.Call call = getLikesCall(albumID, progressListener, progressRequestListener);
        return call;
    ...
    public Likes getLikes(String albumID) throws ApiException {
        ApiResponse<Likes> resp = getLikesWithHttpInfo(albumID);
        return resp.getData();
    }
     ...
     * get likes or dislikes for  album
     * @param albumID albumID (required)
     * @return ApiResponse&lt;Likes&gt;
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<Likes> getLikesWithHttpInfo(String albumID) throws ApiException {
        com.squareup.okhttp.Call call = getLikesValidateBeforeCall(albumID, null, null);
        Type localVarReturnType = new TypeToken<Likes>(){}.getType();
     ...
     */
    public com.squareup.okhttp.Call getLikesAsync(String albumID, final ApiCallback<Likes> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = getLikesValidateBeforeCall(albumID, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<Likes>(){}.getType();
